...
class MemberServiceTest {
	...
	public void 중복회원예외() {
		...
		IllegalStateException e = assertThrows(IllegalStateException.class, () -> memberService.join(member2));  // () -> memberService.join(member2) 실행하기 위해 IllegalStateException 발생해야
